...
type EncodedFileOutput struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	FileType        EncodedFileType        `protobuf:"varint,1,opt,name=file_type,json=fileType,proto3,enum=wirtual.EncodedFileType" json:"file_type,omitempty"` // (optional)
...
type SegmentedFileOutput struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Protocol         SegmentedFileProtocol  `protobuf:"varint,1,opt,name=protocol,proto3,enum=wirtual.SegmentedFileProtocol" json:"protocol,omitempty"`                                  // (optional)
	...
	FilenameSuffix   SegmentedFileSuffix    `protobuf:"varint,10,opt,name=filename_suffix,json=filenameSuffix,proto3,enum=wirtual.SegmentedFileSuffix" json:"filename_suffix,omitempty"` // (optional, default INDEX)
...
type ImageOutput struct {
	...
	FilenameSuffix  ImageFileSuffix        `protobuf:"varint,5,opt,name=filename_suffix,json=filenameSuffix,proto3,enum=wirtual.ImageFileSuffix" json:"filename_suffix,omitempty"` // (optional, default INDEX)
	ImageCodec      ImageCodec             `protobuf:"varint,6,opt,name=image_codec,json=imageCodec,proto3,enum=wirtual.ImageCodec" json:"image_codec,omitempty"`                  // (optional)
...
type StreamOutput struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Protocol      StreamProtocol         `protobuf:"varint,1,opt,name=protocol,proto3,enum=wirtual.StreamProtocol" json:"protocol,omitempty"` // required
...
type EncodingOptions struct {
	...
	AudioCodec       AudioCodec             `protobuf:"varint,5,opt,name=audio_codec,json=audioCodec,proto3,enum=wirtual.AudioCodec" json:"audio_codec,omitempty"` // (default OPUS)
	...
	VideoCodec       VideoCodec             `protobuf:"varint,8,opt,name=video_codec,json=videoCodec,proto3,enum=wirtual.VideoCodec" json:"video_codec,omitempty"` // (default H264_MAIN)
...
type EgressInfo struct {
	...
	SourceType EgressSourceType       `protobuf:"varint,26,opt,name=source_type,json=sourceType,proto3,enum=wirtual.EgressSourceType" json:"source_type,omitempty"`
	Status     EgressStatus           `protobuf:"varint,3,opt,name=status,proto3,enum=wirtual.EgressStatus" json:"status,omitempty"`
...
type StreamInfo struct {
	...
	Status        StreamInfo_Status      `protobuf:"varint,5,opt,name=status,proto3,enum=wirtual.StreamInfo_Status" json:"status,omitempty"`
...
var file_wirtual_egress_proto_goTypes = []any{
	...
	(ImageFileSuffix)(0),                // 3: wirtual.ImageFileSuffix
	(StreamProtocol)(0),                 // 4: wirtual.StreamProtocol
	(EncodingOptionsPreset)(0),          // 5: wirtual.EncodingOptionsPreset
	(EgressStatus)(0),                   // 6: wirtual.EgressStatus
	(EgressSourceType)(0),               // 7: wirtual.EgressSourceType
	(StreamInfo_Status)(0),              // 8: wirtual.StreamInfo.Status
	(*RoomCompositeEgressRequest)(nil),  // 9: wirtual.RoomCompositeEgressRequest
	(*WebEgressRequest)(nil),            // 10: wirtual.WebEgressRequest
	(*ParticipantEgressRequest)(nil),    // 11: wirtual.ParticipantEgressRequest
	(*TrackCompositeEgressRequest)(nil), // 12: wirtual.TrackCompositeEgressRequest
	(*TrackEgressRequest)(nil),          // 13: wirtual.TrackEgressRequest
	(*EncodedFileOutput)(nil),           // 14: wirtual.EncodedFileOutput
	(*SegmentedFileOutput)(nil),         // 15: wirtual.SegmentedFileOutput
	(*DirectFileOutput)(nil),            // 16: wirtual.DirectFileOutput
	(*ImageOutput)(nil),                 // 17: wirtual.ImageOutput
	(*S3Upload)(nil),                    // 18: wirtual.S3Upload
	(*GCPUpload)(nil),                   // 19: wirtual.GCPUpload
	(*AzureBlobUpload)(nil),             // 20: wirtual.AzureBlobUpload
	(*AliOSSUpload)(nil),                // 21: wirtual.AliOSSUpload
	(*ProxyConfig)(nil),                 // 22: wirtual.ProxyConfig
	(*StreamOutput)(nil),                // 23: wirtual.StreamOutput
	(*EncodingOptions)(nil),             // 24: wirtual.EncodingOptions
	(*UpdateLayoutRequest)(nil),         // 25: wirtual.UpdateLayoutRequest
	(*UpdateStreamRequest)(nil),         // 26: wirtual.UpdateStreamRequest
	(*ListEgressRequest)(nil),           // 27: wirtual.ListEgressRequest
	(*ListEgressResponse)(nil),          // 28: wirtual.ListEgressResponse
	(*StopEgressRequest)(nil),           // 29: wirtual.StopEgressRequest
	(*EgressInfo)(nil),                  // 30: wirtual.EgressInfo
	(*StreamInfoList)(nil),              // 31: wirtual.StreamInfoList
	(*StreamInfo)(nil),                  // 32: wirtual.StreamInfo
	(*FileInfo)(nil),                    // 33: wirtual.FileInfo
	(*SegmentsInfo)(nil),                // 34: wirtual.SegmentsInfo
	(*ImagesInfo)(nil),                  // 35: wirtual.ImagesInfo
	(*AutoParticipantEgress)(nil),       // 36: wirtual.AutoParticipantEgress
	(*AutoTrackEgress)(nil),             // 37: wirtual.AutoTrackEgress
	nil,                                 // 38: wirtual.S3Upload.MetadataEntry
	(ImageCodec)(0),                     // 39: wirtual.ImageCodec
...
var file_wirtual_egress_proto_depIdxs = []int32{
	...
	5,  // 3: wirtual.RoomCompositeEgressRequest.preset:type_name -> wirtual.EncodingOptionsPreset
	24, // 4: wirtual.RoomCompositeEgressRequest.advanced:type_name -> wirtual.EncodingOptions
	14, // 5: wirtual.RoomCompositeEgressRequest.file_outputs:type_name -> wirtual.EncodedFileOutput
	23, // 6: wirtual.RoomCompositeEgressRequest.stream_outputs:type_name -> wirtual.StreamOutput
	15, // 7: wirtual.RoomCompositeEgressRequest.segment_outputs:type_name -> wirtual.SegmentedFileOutput
	17, // 8: wirtual.RoomCompositeEgressRequest.image_outputs:type_name -> wirtual.ImageOutput
	14, // 9: wirtual.WebEgressRequest.file:type_name -> wirtual.EncodedFileOutput
	23, // 10: wirtual.WebEgressRequest.stream:type_name -> wirtual.StreamOutput
	15, // 11: wirtual.WebEgressRequest.segments:type_name -> wirtual.SegmentedFileOutput
	5,  // 12: wirtual.WebEgressRequest.preset:type_name -> wirtual.EncodingOptionsPreset
	24, // 13: wirtual.WebEgressRequest.advanced:type_name -> wirtual.EncodingOptions
	14, // 14: wirtual.WebEgressRequest.file_outputs:type_name -> wirtual.EncodedFileOutput
	23, // 15: wirtual.WebEgressRequest.stream_outputs:type_name -> wirtual.StreamOutput
	15, // 16: wirtual.WebEgressRequest.segment_outputs:type_name -> wirtual.SegmentedFileOutput
	17, // 17: wirtual.WebEgressRequest.image_outputs:type_name -> wirtual.ImageOutput
	5,  // 18: wirtual.ParticipantEgressRequest.preset:type_name -> wirtual.EncodingOptionsPreset
	24, // 19: wirtual.ParticipantEgressRequest.advanced:type_name -> wirtual.EncodingOptions
	14, // 20: wirtual.ParticipantEgressRequest.file_outputs:type_name -> wirtual.EncodedFileOutput
	23, // 21: wirtual.ParticipantEgressRequest.stream_outputs:type_name -> wirtual.StreamOutput
	15, // 22: wirtual.ParticipantEgressRequest.segment_outputs:type_name -> wirtual.SegmentedFileOutput
	17, // 23: wirtual.ParticipantEgressRequest.image_outputs:type_name -> wirtual.ImageOutput
	14, // 24: wirtual.TrackCompositeEgressRequest.file:type_name -> wirtual.EncodedFileOutput
	23, // 25: wirtual.TrackCompositeEgressRequest.stream:type_name -> wirtual.StreamOutput
	15, // 26: wirtual.TrackCompositeEgressRequest.segments:type_name -> wirtual.SegmentedFileOutput
	5,  // 27: wirtual.TrackCompositeEgressRequest.preset:type_name -> wirtual.EncodingOptionsPreset
	24, // 28: wirtual.TrackCompositeEgressRequest.advanced:type_name -> wirtual.EncodingOptions
	14, // 29: wirtual.TrackCompositeEgressRequest.file_outputs:type_name -> wirtual.EncodedFileOutput
	23, // 30: wirtual.TrackCompositeEgressRequest.stream_outputs:type_name -> wirtual.StreamOutput
	15, // 31: wirtual.TrackCompositeEgressRequest.segment_outputs:type_name -> wirtual.SegmentedFileOutput
	17, // 32: wirtual.TrackCompositeEgressRequest.image_outputs:type_name -> wirtual.ImageOutput
	16, // 33: wirtual.TrackEgressRequest.file:type_name -> wirtual.DirectFileOutput
	0,  // 34: wirtual.EncodedFileOutput.file_type:type_name -> wirtual.EncodedFileType
	18, // 35: wirtual.EncodedFileOutput.s3:type_name -> wirtual.S3Upload
	19, // 36: wirtual.EncodedFileOutput.gcp:type_name -> wirtual.GCPUpload
	20, // 37: wirtual.EncodedFileOutput.azure:type_name -> wirtual.AzureBlobUpload
	21, // 38: wirtual.EncodedFileOutput.aliOSS:type_name -> wirtual.AliOSSUpload
	1,  // 39: wirtual.SegmentedFileOutput.protocol:type_name -> wirtual.SegmentedFileProtocol
	2,  // 40: wirtual.SegmentedFileOutput.filename_suffix:type_name -> wirtual.SegmentedFileSuffix
	18, // 41: wirtual.SegmentedFileOutput.s3:type_name -> wirtual.S3Upload
	19, // 42: wirtual.SegmentedFileOutput.gcp:type_name -> wirtual.GCPUpload
	20, // 43: wirtual.SegmentedFileOutput.azure:type_name -> wirtual.AzureBlobUpload
	21, // 44: wirtual.SegmentedFileOutput.aliOSS:type_name -> wirtual.AliOSSUpload
	18, // 45: wirtual.DirectFileOutput.s3:type_name -> wirtual.S3Upload
	19, // 46: wirtual.DirectFileOutput.gcp:type_name -> wirtual.GCPUpload
	20, // 47: wirtual.DirectFileOutput.azure:type_name -> wirtual.AzureBlobUpload
	21, // 48: wirtual.DirectFileOutput.aliOSS:type_name -> wirtual.AliOSSUpload
	3,  // 49: wirtual.ImageOutput.filename_suffix:type_name -> wirtual.ImageFileSuffix
	39, // 50: wirtual.ImageOutput.image_codec:type_name -> wirtual.ImageCodec
	18, // 51: wirtual.ImageOutput.s3:type_name -> wirtual.S3Upload
	19, // 52: wirtual.ImageOutput.gcp:type_name -> wirtual.GCPUpload
	20, // 53: wirtual.ImageOutput.azure:type_name -> wirtual.AzureBlobUpload
	21, // 54: wirtual.ImageOutput.aliOSS:type_name -> wirtual.AliOSSUpload
	38, // 55: wirtual.S3Upload.metadata:type_name -> wirtual.S3Upload.MetadataEntry
	22, // 56: wirtual.S3Upload.proxy:type_name -> wirtual.ProxyConfig
	22, // 57: wirtual.GCPUpload.proxy:type_name -> wirtual.ProxyConfig
	4,  // 58: wirtual.StreamOutput.protocol:type_name -> wirtual.StreamProtocol
	40, // 59: wirtual.EncodingOptions.audio_codec:type_name -> wirtual.AudioCodec
	41, // 60: wirtual.EncodingOptions.video_codec:type_name -> wirtual.VideoCodec
	30, // 61: wirtual.ListEgressResponse.items:type_name -> wirtual.EgressInfo
	7,  // 62: wirtual.EgressInfo.source_type:type_name -> wirtual.EgressSourceType
	6,  // 63: wirtual.EgressInfo.status:type_name -> wirtual.EgressStatus
	9,  // 64: wirtual.EgressInfo.room_composite:type_name -> wirtual.RoomCompositeEgressRequest
	10, // 65: wirtual.EgressInfo.web:type_name -> wirtual.WebEgressRequest
	11, // 66: wirtual.EgressInfo.participant:type_name -> wirtual.ParticipantEgressRequest
	12, // 67: wirtual.EgressInfo.track_composite:type_name -> wirtual.TrackCompositeEgressRequest
	13, // 68: wirtual.EgressInfo.track:type_name -> wirtual.TrackEgressRequest
	31, // 69: wirtual.EgressInfo.stream:type_name -> wirtual.StreamInfoList
	33, // 70: wirtual.EgressInfo.file:type_name -> wirtual.FileInfo
	34, // 71: wirtual.EgressInfo.segments:type_name -> wirtual.SegmentsInfo
	32, // 72: wirtual.EgressInfo.stream_results:type_name -> wirtual.StreamInfo
	33, // 73: wirtual.EgressInfo.file_results:type_name -> wirtual.FileInfo
	34, // 74: wirtual.EgressInfo.segment_results:type_name -> wirtual.SegmentsInfo
	35, // 75: wirtual.EgressInfo.image_results:type_name -> wirtual.ImagesInfo
	32, // 76: wirtual.StreamInfoList.info:type_name -> wirtual.StreamInfo
	8,  // 77: wirtual.StreamInfo.status:type_name -> wirtual.StreamInfo.Status
	5,  // 78: wirtual.AutoParticipantEgress.preset:type_name -> wirtual.EncodingOptionsPreset
	24, // 79: wirtual.AutoParticipantEgress.advanced:type_name -> wirtual.EncodingOptions
	14, // 80: wirtual.AutoParticipantEgress.file_outputs:type_name -> wirtual.EncodedFileOutput
	15, // 81: wirtual.AutoParticipantEgress.segment_outputs:type_name -> wirtual.SegmentedFileOutput
	18, // 82: wirtual.AutoTrackEgress.s3:type_name -> wirtual.S3Upload
	19, // 83: wirtual.AutoTrackEgress.gcp:type_name -> wirtual.GCPUpload
	20, // 84: wirtual.AutoTrackEgress.azure:type_name -> wirtual.AzureBlobUpload
	21, // 85: wirtual.AutoTrackEgress.aliOSS:type_name -> wirtual.AliOSSUpload
	9,  // 86: wirtual.Egress.StartRoomCompositeEgress:input_type -> wirtual.RoomCompositeEgressRequest
	10, // 87: wirtual.Egress.StartWebEgress:input_type -> wirtual.WebEgressRequest
	11, // 88: wirtual.Egress.StartParticipantEgress:input_type -> wirtual.ParticipantEgressRequest
	12, // 89: wirtual.Egress.StartTrackCompositeEgress:input_type -> wirtual.TrackCompositeEgressRequest
	13, // 90: wirtual.Egress.StartTrackEgress:input_type -> wirtual.TrackEgressRequest
	25, // 91: wirtual.Egress.UpdateLayout:input_type -> wirtual.UpdateLayoutRequest
	26, // 92: wirtual.Egress.UpdateStream:input_type -> wirtual.UpdateStreamRequest
	27, // 93: wirtual.Egress.ListEgress:input_type -> wirtual.ListEgressRequest
	29, // 94: wirtual.Egress.StopEgress:input_type -> wirtual.StopEgressRequest
	30, // 95: wirtual.Egress.StartRoomCompositeEgress:output_type -> wirtual.EgressInfo
	30, // 96: wirtual.Egress.StartWebEgress:output_type -> wirtual.EgressInfo
	30, // 97: wirtual.Egress.StartParticipantEgress:output_type -> wirtual.EgressInfo
	30, // 98: wirtual.Egress.StartTrackCompositeEgress:output_type -> wirtual.EgressInfo
	30, // 99: wirtual.Egress.StartTrackEgress:output_type -> wirtual.EgressInfo
	30, // 100: wirtual.Egress.UpdateLayout:output_type -> wirtual.EgressInfo
	30, // 101: wirtual.Egress.UpdateStream:output_type -> wirtual.EgressInfo
	28, // 102: wirtual.Egress.ListEgress:output_type -> wirtual.ListEgressResponse
	30, // 103: wirtual.Egress.StopEgress:output_type -> wirtual.EgressInfo
