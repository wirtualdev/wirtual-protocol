...
type Job struct {
	...
	Type        JobType                `protobuf:"varint,2,opt,name=type,proto3,enum=wirtual.JobType" json:"type,omitempty"`
	...
	// Deprecated: Marked as deprecated in wirtual_agent.proto.
...
type JobState struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	Status              JobStatus              `protobuf:"varint,1,opt,name=status,proto3,enum=wirtual.JobStatus" json:"status,omitempty"`
...
type SimulateJobRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          JobType                `protobuf:"varint,1,opt,name=type,proto3,enum=wirtual.JobType" json:"type,omitempty"`
...
type UpdateJobStatus struct {
	...
	Status JobStatus `protobuf:"varint,2,opt,name=status,proto3,enum=wirtual.JobStatus" json:"status,omitempty"`
...
type UpdateWorkerStatus struct {
	state  protoimpl.MessageState `protogen:"open.v1"`
	Status *WorkerStatus          `protobuf:"varint,1,opt,name=status,proto3,enum=wirtual.WorkerStatus,oneof" json:"status,omitempty"`
...
var file_livekit_agent_proto_goTypes = []any{
	...
	(*Job)(nil),                    // 3: wirtual.Job
	(*JobState)(nil),               // 4: wirtual.JobState
	(*WorkerMessage)(nil),          // 5: wirtual.WorkerMessage
	(*ServerMessage)(nil),          // 6: wirtual.ServerMessage
	(*SimulateJobRequest)(nil),     // 7: wirtual.SimulateJobRequest
	(*WorkerPing)(nil),             // 8: wirtual.WorkerPing
	(*WorkerPong)(nil),             // 9: wirtual.WorkerPong
	(*RegisterWorkerRequest)(nil),  // 10: wirtual.RegisterWorkerRequest
	(*RegisterWorkerResponse)(nil), // 11: wirtual.RegisterWorkerResponse
	(*MigrateJobRequest)(nil),      // 12: wirtual.MigrateJobRequest
	(*AvailabilityRequest)(nil),    // 13: wirtual.AvailabilityRequest
	(*AvailabilityResponse)(nil),   // 14: wirtual.AvailabilityResponse
	(*UpdateJobStatus)(nil),        // 15: wirtual.UpdateJobStatus
	(*UpdateWorkerStatus)(nil),     // 16: wirtual.UpdateWorkerStatus
	(*JobAssignment)(nil),          // 17: wirtual.JobAssignment
	(*JobTermination)(nil),         // 18: wirtual.JobTermination
	nil,                            // 19: wirtual.AvailabilityResponse.ParticipantAttributesEntry
	(*Room)(nil),                   // 20: wirtual.Room
	(*ParticipantInfo)(nil),        // 21: wirtual.ParticipantInfo
...
var file_livekit_agent_proto_depIdxs = []int32{
	...
	4,  // 3: wirtual.Job.state:type_name -> wirtual.JobState
	2,  // 4: wirtual.JobState.status:type_name -> wirtual.JobStatus
	10, // 5: wirtual.WorkerMessage.register:type_name -> wirtual.RegisterWorkerRequest
	14, // 6: wirtual.WorkerMessage.availability:type_name -> wirtual.AvailabilityResponse
	16, // 7: wirtual.WorkerMessage.update_worker:type_name -> wirtual.UpdateWorkerStatus
	15, // 8: wirtual.WorkerMessage.update_job:type_name -> wirtual.UpdateJobStatus
	8,  // 9: wirtual.WorkerMessage.ping:type_name -> wirtual.WorkerPing
	7,  // 10: wirtual.WorkerMessage.simulate_job:type_name -> wirtual.SimulateJobRequest
	12, // 11: wirtual.WorkerMessage.migrate_job:type_name -> wirtual.MigrateJobRequest
	11, // 12: wirtual.ServerMessage.register:type_name -> wirtual.RegisterWorkerResponse
	13, // 13: wirtual.ServerMessage.availability:type_name -> wirtual.AvailabilityRequest
	17, // 14: wirtual.ServerMessage.assignment:type_name -> wirtual.JobAssignment
	18, // 15: wirtual.ServerMessage.termination:type_name -> wirtual.JobTermination
	9,  // 16: wirtual.ServerMessage.pong:type_name -> wirtual.WorkerPong
	0,  // 17: wirtual.SimulateJobRequest.type:type_name -> wirtual.JobType
	20, // 18: wirtual.SimulateJobRequest.room:type_name -> wirtual.Room
	21, // 19: wirtual.SimulateJobRequest.participant:type_name -> wirtual.ParticipantInfo
	0,  // 20: wirtual.RegisterWorkerRequest.type:type_name -> wirtual.JobType
	22, // 21: wirtual.RegisterWorkerRequest.allowed_permissions:type_name -> wirtual.ParticipantPermission
	23, // 22: wirtual.RegisterWorkerResponse.server_info:type_name -> wirtual.ServerInfo
	3,  // 23: wirtual.AvailabilityRequest.job:type_name -> wirtual.Job
	19, // 24: wirtual.AvailabilityResponse.participant_attributes:type_name -> wirtual.AvailabilityResponse.ParticipantAttributesEntry
	2,  // 25: wirtual.UpdateJobStatus.status:type_name -> wirtual.JobStatus
	1,  // 26: wirtual.UpdateWorkerStatus.status:type_name -> wirtual.WorkerStatus
	3,  // 27: wirtual.JobAssignment.job:type_name -> wirtual.Job
