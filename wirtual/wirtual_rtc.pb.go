...
type AddTrackRequest struct {
	...
	Type TrackType `protobuf:"varint,3,opt,name=type,proto3,enum=wirtual.TrackType" json:"type,omitempty"`
	...
	Source          TrackSource       `protobuf:"varint,8,opt,name=source,proto3,enum=wirtual.TrackSource" json:"source,omitempty"`
	...
	Encryption Encryption_Type `protobuf:"varint,14,opt,name=encryption,proto3,enum=wirtual.Encryption_Type" json:"encryption,omitempty"`
...
type TrickleRequest struct {
	...
	Target        SignalTarget           `protobuf:"varint,2,opt,name=target,proto3,enum=wirtual.SignalTarget" json:"target,omitempty"`
...
type UpdateTrackSettings struct {
	...
	Quality VideoQuality `protobuf:"varint,4,opt,name=quality,proto3,enum=wirtual.VideoQuality" json:"quality,omitempty"`
...
type UpdateLocalAudioTrack struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TrackSid      string                 `protobuf:"bytes,1,opt,name=track_sid,json=trackSid,proto3" json:"track_sid,omitempty"`
	Features      []AudioTrackFeature    `protobuf:"varint,2,rep,packed,name=features,proto3,enum=wirtual.AudioTrackFeature" json:"features,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LeaveRequest struct {
	...
	Reason        DisconnectReason    `protobuf:"varint,2,opt,name=reason,proto3,enum=wirtual.DisconnectReason" json:"reason,omitempty"`
	Action        LeaveRequest_Action `protobuf:"varint,3,opt,name=action,proto3,enum=wirtual.LeaveRequest_Action" json:"action,omitempty"`
...
type ConnectionQualityInfo struct {
	...
	Quality        ConnectionQuality      `protobuf:"varint,2,opt,name=quality,proto3,enum=wirtual.ConnectionQuality" json:"quality,omitempty"`
...
type StreamStateInfo struct {
	...
	State          StreamState            `protobuf:"varint,3,opt,name=state,proto3,enum=wirtual.StreamState" json:"state,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type SubscribedQuality struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Quality       VideoQuality           `protobuf:"varint,1,opt,name=quality,proto3,enum=wirtual.VideoQuality" json:"quality,omitempty"`
...
type DataChannelInfo struct {
	...
	Target        SignalTarget           `protobuf:"varint,3,opt,name=target,proto3,enum=wirtual.SignalTarget" json:"target,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SimulateScenario_SwitchCandidateProtocol struct {
	...
	SwitchCandidateProtocol CandidateProtocol `protobuf:"varint,5,opt,name=switch_candidate_protocol,json=switchCandidateProtocol,proto3,enum=wirtual.CandidateProtocol,oneof"`
}
...
type SubscriptionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TrackSid      string                 `protobuf:"bytes,1,opt,name=track_sid,json=trackSid,proto3" json:"track_sid,omitempty"`
	Err           SubscriptionError      `protobuf:"varint,2,opt,name=err,proto3,enum=wirtual.SubscriptionError" json:"err,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RequestResponse struct {
	...
	Reason        RequestResponse_Reason `protobuf:"varint,2,opt,name=reason,proto3,enum=wirtual.RequestResponse_Reason" json:"reason,omitempty"`
...
var file_wirtual_rtc_proto_goTypes = []any{
	...
	(LeaveRequest_Action)(0),             // 3: wirtual.LeaveRequest.Action
	(RequestResponse_Reason)(0),          // 4: wirtual.RequestResponse.Reason
	(*SignalRequest)(nil),                // 5: wirtual.SignalRequest
	(*SignalResponse)(nil),               // 6: wirtual.SignalResponse
	(*SimulcastCodec)(nil),               // 7: wirtual.SimulcastCodec
	(*AddTrackRequest)(nil),              // 8: wirtual.AddTrackRequest
	(*TrickleRequest)(nil),               // 9: wirtual.TrickleRequest
	(*MuteTrackRequest)(nil),             // 10: wirtual.MuteTrackRequest
	(*JoinResponse)(nil),                 // 11: wirtual.JoinResponse
	(*ReconnectResponse)(nil),            // 12: wirtual.ReconnectResponse
	(*TrackPublishedResponse)(nil),       // 13: wirtual.TrackPublishedResponse
	(*TrackUnpublishedResponse)(nil),     // 14: wirtual.TrackUnpublishedResponse
	(*SessionDescription)(nil),           // 15: wirtual.SessionDescription
	(*ParticipantUpdate)(nil),            // 16: wirtual.ParticipantUpdate
	(*UpdateSubscription)(nil),           // 17: wirtual.UpdateSubscription
	(*UpdateTrackSettings)(nil),          // 18: wirtual.UpdateTrackSettings
	(*UpdateLocalAudioTrack)(nil),        // 19: wirtual.UpdateLocalAudioTrack
	(*UpdateLocalVideoTrack)(nil),        // 20: wirtual.UpdateLocalVideoTrack
	(*LeaveRequest)(nil),                 // 21: wirtual.LeaveRequest
	(*UpdateVideoLayers)(nil),            // 22: wirtual.UpdateVideoLayers
	(*UpdateParticipantMetadata)(nil),    // 23: wirtual.UpdateParticipantMetadata
	(*ICEServer)(nil),                    // 24: wirtual.ICEServer
	(*SpeakersChanged)(nil),              // 25: wirtual.SpeakersChanged
	(*RoomUpdate)(nil),                   // 26: wirtual.RoomUpdate
	(*ConnectionQualityInfo)(nil),        // 27: wirtual.ConnectionQualityInfo
	(*ConnectionQualityUpdate)(nil),      // 28: wirtual.ConnectionQualityUpdate
	(*StreamStateInfo)(nil),              // 29: wirtual.StreamStateInfo
	(*StreamStateUpdate)(nil),            // 30: wirtual.StreamStateUpdate
	(*SubscribedQuality)(nil),            // 31: wirtual.SubscribedQuality
	(*SubscribedCodec)(nil),              // 32: wirtual.SubscribedCodec
	(*SubscribedQualityUpdate)(nil),      // 33: wirtual.SubscribedQualityUpdate
	(*TrackPermission)(nil),              // 34: wirtual.TrackPermission
	(*SubscriptionPermission)(nil),       // 35: wirtual.SubscriptionPermission
	(*SubscriptionPermissionUpdate)(nil), // 36: wirtual.SubscriptionPermissionUpdate
	(*SyncState)(nil),                    // 37: wirtual.SyncState
	(*DataChannelInfo)(nil),              // 38: wirtual.DataChannelInfo
	(*SimulateScenario)(nil),             // 39: wirtual.SimulateScenario
	(*Ping)(nil),                         // 40: wirtual.Ping
	(*Pong)(nil),                         // 41: wirtual.Pong
	(*RegionSettings)(nil),               // 42: wirtual.RegionSettings
	(*RegionInfo)(nil),                   // 43: wirtual.RegionInfo
	(*SubscriptionResponse)(nil),         // 44: wirtual.SubscriptionResponse
	(*RequestResponse)(nil),              // 45: wirtual.RequestResponse
	(*TrackSubscribed)(nil),              // 46: wirtual.TrackSubscribed
	nil,                                  // 47: wirtual.UpdateParticipantMetadata.AttributesEntry
	(TrackType)(0),                       // 48: wirtual.TrackType
	(TrackSource)(0),                     // 49: wirtual.TrackSource
	(*VideoLayer)(nil),                   // 50: wirtual.VideoLayer
	(Encryption_Type)(0),                 // 51: wirtual.Encryption.Type
	(*Room)(nil),                         // 52: wirtual.Room
	(*ParticipantInfo)(nil),              // 53: wirtual.ParticipantInfo
	(*ClientConfiguration)(nil),          // 54: wirtual.ClientConfiguration
	(*ServerInfo)(nil),                   // 55: wirtual.ServerInfo
	(*Codec)(nil),                        // 56: wirtual.Codec
	(*TrackInfo)(nil),                    // 57: wirtual.TrackInfo
	(*ParticipantTracks)(nil),            // 58: wirtual.ParticipantTracks
	(VideoQuality)(0),                    // 59: wirtual.VideoQuality
	(AudioTrackFeature)(0),               // 60: wirtual.AudioTrackFeature
	(DisconnectReason)(0),                // 61: wirtual.DisconnectReason
	(*SpeakerInfo)(nil),                  // 62: wirtual.SpeakerInfo
...
var file_wirtual_rtc_proto_depIdxs = []int32{
	...
	8,  // 3: wirtual.SignalRequest.add_track:type_name -> wirtual.AddTrackRequest
	10, // 4: wirtual.SignalRequest.mute:type_name -> wirtual.MuteTrackRequest
	17, // 5: wirtual.SignalRequest.subscription:type_name -> wirtual.UpdateSubscription
	18, // 6: wirtual.SignalRequest.track_setting:type_name -> wirtual.UpdateTrackSettings
	21, // 7: wirtual.SignalRequest.leave:type_name -> wirtual.LeaveRequest
	22, // 8: wirtual.SignalRequest.update_layers:type_name -> wirtual.UpdateVideoLayers
	35, // 9: wirtual.SignalRequest.subscription_permission:type_name -> wirtual.SubscriptionPermission
	37, // 10: wirtual.SignalRequest.sync_state:type_name -> wirtual.SyncState
	39, // 11: wirtual.SignalRequest.simulate:type_name -> wirtual.SimulateScenario
	23, // 12: wirtual.SignalRequest.update_metadata:type_name -> wirtual.UpdateParticipantMetadata
	40, // 13: wirtual.SignalRequest.ping_req:type_name -> wirtual.Ping
	19, // 14: wirtual.SignalRequest.update_audio_track:type_name -> wirtual.UpdateLocalAudioTrack
	20, // 15: wirtual.SignalRequest.update_video_track:type_name -> wirtual.UpdateLocalVideoTrack
	11, // 16: wirtual.SignalResponse.join:type_name -> wirtual.JoinResponse
	15, // 17: wirtual.SignalResponse.answer:type_name -> wirtual.SessionDescription
	15, // 18: wirtual.SignalResponse.offer:type_name -> wirtual.SessionDescription
	9,  // 19: wirtual.SignalResponse.trickle:type_name -> wirtual.TrickleRequest
	16, // 20: wirtual.SignalResponse.update:type_name -> wirtual.ParticipantUpdate
	13, // 21: wirtual.SignalResponse.track_published:type_name -> wirtual.TrackPublishedResponse
	21, // 22: wirtual.SignalResponse.leave:type_name -> wirtual.LeaveRequest
	10, // 23: wirtual.SignalResponse.mute:type_name -> wirtual.MuteTrackRequest
	25, // 24: wirtual.SignalResponse.speakers_changed:type_name -> wirtual.SpeakersChanged
	26, // 25: wirtual.SignalResponse.room_update:type_name -> wirtual.RoomUpdate
	28, // 26: wirtual.SignalResponse.connection_quality:type_name -> wirtual.ConnectionQualityUpdate
	30, // 27: wirtual.SignalResponse.stream_state_update:type_name -> wirtual.StreamStateUpdate
	33, // 28: wirtual.SignalResponse.subscribed_quality_update:type_name -> wirtual.SubscribedQualityUpdate
	36, // 29: wirtual.SignalResponse.subscription_permission_update:type_name -> wirtual.SubscriptionPermissionUpdate
	14, // 30: wirtual.SignalResponse.track_unpublished:type_name -> wirtual.TrackUnpublishedResponse
	12, // 31: wirtual.SignalResponse.reconnect:type_name -> wirtual.ReconnectResponse
	41, // 32: wirtual.SignalResponse.pong_resp:type_name -> wirtual.Pong
	44, // 33: wirtual.SignalResponse.subscription_response:type_name -> wirtual.SubscriptionResponse
	45, // 34: wirtual.SignalResponse.request_response:type_name -> wirtual.RequestResponse
	46, // 35: wirtual.SignalResponse.track_subscribed:type_name -> wirtual.TrackSubscribed
	48, // 36: wirtual.AddTrackRequest.type:type_name -> wirtual.TrackType
	49, // 37: wirtual.AddTrackRequest.source:type_name -> wirtual.TrackSource
	50, // 38: wirtual.AddTrackRequest.layers:type_name -> wirtual.VideoLayer
	7,  // 39: wirtual.AddTrackRequest.simulcast_codecs:type_name -> wirtual.SimulcastCodec
	51, // 40: wirtual.AddTrackRequest.encryption:type_name -> wirtual.Encryption.Type
	0,  // 41: wirtual.TrickleRequest.target:type_name -> wirtual.SignalTarget
	52, // 42: wirtual.JoinResponse.room:type_name -> wirtual.Room
	53, // 43: wirtual.JoinResponse.participant:type_name -> wirtual.ParticipantInfo
	53, // 44: wirtual.JoinResponse.other_participants:type_name -> wirtual.ParticipantInfo
	24, // 45: wirtual.JoinResponse.ice_servers:type_name -> wirtual.ICEServer
	54, // 46: wirtual.JoinResponse.client_configuration:type_name -> wirtual.ClientConfiguration
	55, // 47: wirtual.JoinResponse.server_info:type_name -> wirtual.ServerInfo
	56, // 48: wirtual.JoinResponse.enabled_publish_codecs:type_name -> wirtual.Codec
	24, // 49: wirtual.ReconnectResponse.ice_servers:type_name -> wirtual.ICEServer
	54, // 50: wirtual.ReconnectResponse.client_configuration:type_name -> wirtual.ClientConfiguration
	57, // 51: wirtual.TrackPublishedResponse.track:type_name -> wirtual.TrackInfo
	53, // 52: wirtual.ParticipantUpdate.participants:type_name -> wirtual.ParticipantInfo
	58, // 53: wirtual.UpdateSubscription.participant_tracks:type_name -> wirtual.ParticipantTracks
	59, // 54: wirtual.UpdateTrackSettings.quality:type_name -> wirtual.VideoQuality
	60, // 55: wirtual.UpdateLocalAudioTrack.features:type_name -> wirtual.AudioTrackFeature
	61, // 56: wirtual.LeaveRequest.reason:type_name -> wirtual.DisconnectReason
	3,  // 57: wirtual.LeaveRequest.action:type_name -> wirtual.LeaveRequest.Action
	42, // 58: wirtual.LeaveRequest.regions:type_name -> wirtual.RegionSettings
	50, // 59: wirtual.UpdateVideoLayers.layers:type_name -> wirtual.VideoLayer
	47, // 60: wirtual.UpdateParticipantMetadata.attributes:type_name -> wirtual.UpdateParticipantMetadata.AttributesEntry
	62, // 61: wirtual.SpeakersChanged.speakers:type_name -> wirtual.SpeakerInfo
	52, // 62: wirtual.RoomUpdate.room:type_name -> wirtual.Room
	63, // 63: wirtual.ConnectionQualityInfo.quality:type_name -> wirtual.ConnectionQuality
	27, // 64: wirtual.ConnectionQualityUpdate.updates:type_name -> wirtual.ConnectionQualityInfo
	1,  // 65: wirtual.StreamStateInfo.state:type_name -> wirtual.StreamState
	29, // 66: wirtual.StreamStateUpdate.stream_states:type_name -> wirtual.StreamStateInfo
	59, // 67: wirtual.SubscribedQuality.quality:type_name -> wirtual.VideoQuality
	31, // 68: wirtual.SubscribedCodec.qualities:type_name -> wirtual.SubscribedQuality
	31, // 69: wirtual.SubscribedQualityUpdate.subscribed_qualities:type_name -> wirtual.SubscribedQuality
	32, // 70: wirtual.SubscribedQualityUpdate.subscribed_codecs:type_name -> wirtual.SubscribedCodec
	34, // 71: wirtual.SubscriptionPermission.track_permissions:type_name -> wirtual.TrackPermission
	15, // 72: wirtual.SyncState.answer:type_name -> wirtual.SessionDescription
	17, // 73: wirtual.SyncState.subscription:type_name -> wirtual.UpdateSubscription
	13, // 74: wirtual.SyncState.publish_tracks:type_name -> wirtual.TrackPublishedResponse
	38, // 75: wirtual.SyncState.data_channels:type_name -> wirtual.DataChannelInfo
	15, // 76: wirtual.SyncState.offer:type_name -> wirtual.SessionDescription
	0,  // 77: wirtual.DataChannelInfo.target:type_name -> wirtual.SignalTarget
	2,  // 78: wirtual.SimulateScenario.switch_candidate_protocol:type_name -> wirtual.CandidateProtocol
	43, // 79: wirtual.RegionSettings.regions:type_name -> wirtual.RegionInfo
	64, // 80: wirtual.SubscriptionResponse.err:type_name -> wirtual.SubscriptionError
	4,  // 81: wirtual.RequestResponse.reason:type_name -> wirtual.RequestResponse.Reason
