...
type CreateIngressRequest struct {
	...
	InputType IngressInput           `protobuf:"varint,1,opt,name=input_type,json=inputType,proto3,enum=wirtual.IngressInput" json:"input_type,omitempty"`
...
type IngressAudioOptions struct {
	...
	Source TrackSource            `protobuf:"varint,2,opt,name=source,proto3,enum=wirtual.TrackSource" json:"source,omitempty"`
...
type IngressAudioEncodingOptions struct {
	...
	AudioCodec    AudioCodec `protobuf:"varint,1,opt,name=audio_codec,json=audioCodec,proto3,enum=wirtual.AudioCodec" json:"audio_codec,omitempty"`
...
type IngressVideoEncodingOptions struct {
	...
	VideoCodec VideoCodec `protobuf:"varint,1,opt,name=video_codec,json=videoCodec,proto3,enum=wirtual.VideoCodec" json:"video_codec,omitempty"`
...
type IngressInfo struct {
	...
	InputType IngressInput `protobuf:"varint,5,opt,name=input_type,json=inputType,proto3,enum=wirtual.IngressInput" json:"input_type,omitempty"`
	// Deprecated: Marked as deprecated in wirtual_ingress.proto.
...
type IngressState struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        IngressState_Status    `protobuf:"varint,1,opt,name=status,proto3,enum=wirtual.IngressState_Status" json:"status,omitempty"`
...
var file_wirtual_ingress_proto_goTypes = []any{
	...
	(IngressState_Status)(0),            // 3: wirtual.IngressState.Status
	(*CreateIngressRequest)(nil),        // 4: wirtual.CreateIngressRequest
	(*IngressAudioOptions)(nil),         // 5: wirtual.IngressAudioOptions
	(*IngressVideoOptions)(nil),         // 6: wirtual.IngressVideoOptions
	(*IngressAudioEncodingOptions)(nil), // 7: wirtual.IngressAudioEncodingOptions
	(*IngressVideoEncodingOptions)(nil), // 8: wirtual.IngressVideoEncodingOptions
	(*IngressInfo)(nil),                 // 9: wirtual.IngressInfo
	(*IngressState)(nil),                // 10: wirtual.IngressState
	(*InputVideoState)(nil),             // 11: wirtual.InputVideoState
	(*InputAudioState)(nil),             // 12: wirtual.InputAudioState
	(*UpdateIngressRequest)(nil),        // 13: wirtual.UpdateIngressRequest
	(*ListIngressRequest)(nil),          // 14: wirtual.ListIngressRequest
	(*ListIngressResponse)(nil),         // 15: wirtual.ListIngressResponse
	(*DeleteIngressRequest)(nil),        // 16: wirtual.DeleteIngressRequest
	(TrackSource)(0),                    // 17: wirtual.TrackSource
	(AudioCodec)(0),                     // 18: wirtual.AudioCodec
	(VideoCodec)(0),                     // 19: wirtual.VideoCodec
...
var file_wirtual_ingress_proto_depIdxs = []int32{
	...
	17, // 3: wirtual.IngressAudioOptions.source:type_name -> wirtual.TrackSource
	1,  // 4: wirtual.IngressAudioOptions.preset:type_name -> wirtual.IngressAudioEncodingPreset
	7,  // 5: wirtual.IngressAudioOptions.options:type_name -> wirtual.IngressAudioEncodingOptions
	17, // 6: wirtual.IngressVideoOptions.source:type_name -> wirtual.TrackSource
	2,  // 7: wirtual.IngressVideoOptions.preset:type_name -> wirtual.IngressVideoEncodingPreset
	8,  // 8: wirtual.IngressVideoOptions.options:type_name -> wirtual.IngressVideoEncodingOptions
	18, // 9: wirtual.IngressAudioEncodingOptions.audio_codec:type_name -> wirtual.AudioCodec
	19, // 10: wirtual.IngressVideoEncodingOptions.video_codec:type_name -> wirtual.VideoCodec
	20, // 11: wirtual.IngressVideoEncodingOptions.layers:type_name -> wirtual.VideoLayer
	0,  // 12: wirtual.IngressInfo.input_type:type_name -> wirtual.IngressInput
	5,  // 13: wirtual.IngressInfo.audio:type_name -> wirtual.IngressAudioOptions
	6,  // 14: wirtual.IngressInfo.video:type_name -> wirtual.IngressVideoOptions
	10, // 15: wirtual.IngressInfo.state:type_name -> wirtual.IngressState
	3,  // 16: wirtual.IngressState.status:type_name -> wirtual.IngressState.Status
	11, // 17: wirtual.IngressState.video:type_name -> wirtual.InputVideoState
	12, // 18: wirtual.IngressState.audio:type_name -> wirtual.InputAudioState
	21, // 19: wirtual.IngressState.tracks:type_name -> wirtual.TrackInfo
	5,  // 20: wirtual.UpdateIngressRequest.audio:type_name -> wirtual.IngressAudioOptions
	6,  // 21: wirtual.UpdateIngressRequest.video:type_name -> wirtual.IngressVideoOptions
	9,  // 22: wirtual.ListIngressResponse.items:type_name -> wirtual.IngressInfo
	4,  // 23: wirtual.Ingress.CreateIngress:input_type -> wirtual.CreateIngressRequest
	13, // 24: wirtual.Ingress.UpdateIngress:input_type -> wirtual.UpdateIngressRequest
	14, // 25: wirtual.Ingress.ListIngress:input_type -> wirtual.ListIngressRequest
	16, // 26: wirtual.Ingress.DeleteIngress:input_type -> wirtual.DeleteIngressRequest
	9,  // 27: wirtual.Ingress.CreateIngress:output_type -> wirtual.IngressInfo
	9,  // 28: wirtual.Ingress.UpdateIngress:output_type -> wirtual.IngressInfo
	15, // 29: wirtual.Ingress.ListIngress:output_type -> wirtual.ListIngressResponse
	9,  // 30: wirtual.Ingress.DeleteIngress:output_type -> wirtual.IngressInfo
