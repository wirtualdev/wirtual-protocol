...
type Node struct {
	...
	Type          NodeType               `protobuf:"varint,5,opt,name=type,proto3,enum=wirtual.NodeType" json:"type,omitempty"`
	State         NodeState              `protobuf:"varint,6,opt,name=state,proto3,enum=wirtual.NodeState" json:"state,omitempty"`
...
type StartSession struct {
	...
	ReconnectReason      ReconnectReason    `protobuf:"varint,17,opt,name=reconnect_reason,json=reconnectReason,proto3,enum=wirtual.ReconnectReason" json:"reconnect_reason,omitempty"`
...
type ICEConfig struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	PreferenceSubscriber ICECandidateType       `protobuf:"varint,1,opt,name=preference_subscriber,json=preferenceSubscriber,proto3,enum=wirtual.ICECandidateType" json:"preference_subscriber,omitempty"`
	PreferencePublisher  ICECandidateType       `protobuf:"varint,2,opt,name=preference_publisher,json=preferencePublisher,proto3,enum=wirtual.ICECandidateType" json:"preference_publisher,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
var file_livekit_internal_proto_goTypes = []any{
	...
	(*Node)(nil),                  // 3: wirtual.Node
	(*NodeStats)(nil),             // 4: wirtual.NodeStats
	(*StartSession)(nil),          // 5: wirtual.StartSession
	(*RoomInternal)(nil),          // 6: wirtual.RoomInternal
	(*ICEConfig)(nil),             // 7: wirtual.ICEConfig
	(*ClientInfo)(nil),            // 8: wirtual.ClientInfo
	(ReconnectReason)(0),          // 9: wirtual.ReconnectReason
	(*CreateRoomRequest)(nil),     // 10: wirtual.CreateRoomRequest
	(*AutoTrackEgress)(nil),       // 11: wirtual.AutoTrackEgress
	(*AutoParticipantEgress)(nil), // 12: wirtual.AutoParticipantEgress
...
var file_livekit_internal_proto_depIdxs = []int32{
	...
	8,  // 3: wirtual.StartSession.client:type_name -> wirtual.ClientInfo
	9,  // 4: wirtual.StartSession.reconnect_reason:type_name -> wirtual.ReconnectReason
	10, // 5: wirtual.StartSession.create_room:type_name -> wirtual.CreateRoomRequest
	11, // 6: wirtual.RoomInternal.track_egress:type_name -> wirtual.AutoTrackEgress
	12, // 7: wirtual.RoomInternal.participant_egress:type_name -> wirtual.AutoParticipantEgress
	13, // 8: wirtual.RoomInternal.playout_delay:type_name -> wirtual.PlayoutDelay
	14, // 9: wirtual.RoomInternal.agent_dispatches:type_name -> wirtual.RoomAgentDispatch
	2,  // 10: wirtual.ICEConfig.preference_subscriber:type_name -> wirtual.ICECandidateType
	2,  // 11: wirtual.ICEConfig.preference_publisher:type_name -> wirtual.ICECandidateType
