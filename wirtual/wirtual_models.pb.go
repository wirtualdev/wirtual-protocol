...
type ParticipantPermission struct {
	...
	CanPublishSources []TrackSource `protobuf:"varint,9,rep,packed,name=can_publish_sources,json=canPublishSources,proto3,enum=wirtual.TrackSource" json:"can_publish_sources,omitempty"`
...
type ParticipantInfo struct {
	...
	State    ParticipantInfo_State  `protobuf:"varint,3,opt,name=state,proto3,enum=wirtual.ParticipantInfo_State" json:"state,omitempty"`
	...
	Kind             ParticipantInfo_Kind `protobuf:"varint,14,opt,name=kind,proto3,enum=wirtual.ParticipantInfo_Kind" json:"kind,omitempty"`
	...
	DisconnectReason DisconnectReason     `protobuf:"varint,16,opt,name=disconnect_reason,json=disconnectReason,proto3,enum=wirtual.DisconnectReason" json:"disconnect_reason,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type TrackInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Sid   string                 `protobuf:"bytes,1,opt,name=sid,proto3" json:"sid,omitempty"`
	Type  TrackType              `protobuf:"varint,2,opt,name=type,proto3,enum=wirtual.TrackType" json:"type,omitempty"`
	...
	// source of media
	Source TrackSource   `protobuf:"varint,9,opt,name=source,proto3,enum=wirtual.TrackSource" json:"source,omitempty"`
	...
	Encryption    Encryption_Type     `protobuf:"varint,16,opt,name=encryption,proto3,enum=wirtual.Encryption_Type" json:"encryption,omitempty"`
	...
	AudioFeatures []AudioTrackFeature `protobuf:"varint,19,rep,packed,name=audio_features,json=audioFeatures,proto3,enum=wirtual.AudioTrackFeature" json:"audio_features,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DataPacket struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Deprecated: Marked as deprecated in wirtual_models.proto.
	Kind DataPacket_Kind `protobuf:"varint,1,opt,name=kind,proto3,enum=wirtual.DataPacket_Kind" json:"kind,omitempty"`
...
type ServerInfo struct {
	state    protoimpl.MessageState `protogen:"open.v1"`
	Edition  ServerInfo_Edition     `protobuf:"varint,1,opt,name=edition,proto3,enum=wirtual.ServerInfo_Edition" json:"edition,omitempty"`
...
type ClientInfo struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Sdk            ClientInfo_SDK         `protobuf:"varint,1,opt,name=sdk,proto3,enum=wirtual.ClientInfo_SDK" json:"sdk,omitempty"`
	Version        string                 `protobuf:"bytes,2,opt,name=version,proto3" json:"version,omitempty"`
	Protocol       int32                  `protobuf:"varint,3,opt,name=protocol,proto3" json:"protocol,omitempty"`
...
type ClientConfiguration struct {
	...
	ResumeConnection ClientConfigSetting    `protobuf:"varint,3,opt,name=resume_connection,json=resumeConnection,proto3,enum=wirtual.ClientConfigSetting" json:"resume_connection,omitempty"`
	...
	ForceRelay       ClientConfigSetting    `protobuf:"varint,5,opt,name=force_relay,json=forceRelay,proto3,enum=wirtual.ClientConfigSetting" json:"force_relay,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type VideoConfiguration struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	HardwareEncoder ClientConfigSetting    `protobuf:"varint,1,opt,name=hardware_encoder,json=hardwareEncoder,proto3,enum=wirtual.ClientConfigSetting" json:"hardware_encoder,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type DataStream_TextHeader struct {
	state             protoimpl.MessageState   `protogen:"open.v1"`
	OperationType     DataStream_OperationType `protobuf:"varint,1,opt,name=operation_type,json=operationType,proto3,enum=wirtual.DataStream_OperationType" json:"operation_type,omitempty"`
...
type DataStream_Header struct {
	...
	EncryptionType Encryption_Type        `protobuf:"varint,7,opt,name=encryption_type,json=encryptionType,proto3,enum=wirtual.Encryption_Type" json:"encryption_type,omitempty"`               // defaults to NONE
...
var file_wirtual_models_proto_goTypes = []any{
	...
	(TrackType)(0),                // 3: wirtual.TrackType
	(TrackSource)(0),              // 4: wirtual.TrackSource
	(VideoQuality)(0),             // 5: wirtual.VideoQuality
	(ConnectionQuality)(0),        // 6: wirtual.ConnectionQuality
	(ClientConfigSetting)(0),      // 7: wirtual.ClientConfigSetting
	(DisconnectReason)(0),         // 8: wirtual.DisconnectReason
	(ReconnectReason)(0),          // 9: wirtual.ReconnectReason
	(SubscriptionError)(0),        // 10: wirtual.SubscriptionError
	(AudioTrackFeature)(0),        // 11: wirtual.AudioTrackFeature
	(ParticipantInfo_State)(0),    // 12: wirtual.ParticipantInfo.State
	(ParticipantInfo_Kind)(0),     // 13: wirtual.ParticipantInfo.Kind
	(Encryption_Type)(0),          // 14: wirtual.Encryption.Type
	(DataPacket_Kind)(0),          // 15: wirtual.DataPacket.Kind
	(ServerInfo_Edition)(0),       // 16: wirtual.ServerInfo.Edition
	(ClientInfo_SDK)(0),           // 17: wirtual.ClientInfo.SDK
	(DataStream_OperationType)(0), // 18: wirtual.DataStream.OperationType
	(*Room)(nil),                  // 19: wirtual.Room
	(*Codec)(nil),                 // 20: wirtual.Codec
	(*PlayoutDelay)(nil),          // 21: wirtual.PlayoutDelay
	(*ParticipantPermission)(nil), // 22: wirtual.ParticipantPermission
	(*ParticipantInfo)(nil),       // 23: wirtual.ParticipantInfo
	(*Encryption)(nil),            // 24: wirtual.Encryption
	(*SimulcastCodecInfo)(nil),    // 25: wirtual.SimulcastCodecInfo
	(*TrackInfo)(nil),             // 26: wirtual.TrackInfo
	(*VideoLayer)(nil),            // 27: wirtual.VideoLayer
	(*DataPacket)(nil),            // 28: wirtual.DataPacket
	(*ActiveSpeakerUpdate)(nil),   // 29: wirtual.ActiveSpeakerUpdate
	(*SpeakerInfo)(nil),           // 30: wirtual.SpeakerInfo
	(*UserPacket)(nil),            // 31: wirtual.UserPacket
	(*SipDTMF)(nil),               // 32: wirtual.SipDTMF
	(*Transcription)(nil),         // 33: wirtual.Transcription
	(*TranscriptionSegment)(nil),  // 34: wirtual.TranscriptionSegment
	(*ChatMessage)(nil),           // 35: wirtual.ChatMessage
	(*RpcRequest)(nil),            // 36: wirtual.RpcRequest
	(*RpcAck)(nil),                // 37: wirtual.RpcAck
	(*RpcResponse)(nil),           // 38: wirtual.RpcResponse
	(*RpcError)(nil),              // 39: wirtual.RpcError
	(*ParticipantTracks)(nil),     // 40: wirtual.ParticipantTracks
	(*ServerInfo)(nil),            // 41: wirtual.ServerInfo
	(*ClientInfo)(nil),            // 42: wirtual.ClientInfo
	(*ClientConfiguration)(nil),   // 43: wirtual.ClientConfiguration
	(*VideoConfiguration)(nil),    // 44: wirtual.VideoConfiguration
	(*DisabledCodecs)(nil),        // 45: wirtual.DisabledCodecs
	(*RTPDrift)(nil),              // 46: wirtual.RTPDrift
	(*RTPStats)(nil),              // 47: wirtual.RTPStats
	(*RTCPSenderReportState)(nil), // 48: wirtual.RTCPSenderReportState
	(*RTPForwarderState)(nil),     // 49: wirtual.RTPForwarderState
	(*RTPMungerState)(nil),        // 50: wirtual.RTPMungerState
	(*VP8MungerState)(nil),        // 51: wirtual.VP8MungerState
	(*TimedVersion)(nil),          // 52: wirtual.TimedVersion
	(*DataStream)(nil),            // 53: wirtual.DataStream
	nil,                           // 54: wirtual.ParticipantInfo.AttributesEntry
	nil,                           // 55: wirtual.RTPStats.GapHistogramEntry
	(*DataStream_TextHeader)(nil), // 56: wirtual.DataStream.TextHeader
	(*DataStream_FileHeader)(nil), // 57: wirtual.DataStream.FileHeader
	(*DataStream_Header)(nil),     // 58: wirtual.DataStream.Header
	(*DataStream_Chunk)(nil),      // 59: wirtual.DataStream.Chunk
	nil,                           // 60: wirtual.DataStream.Header.ExtensionsEntry
...
var file_wirtual_models_proto_depIdxs = []int32{
	...
	12, // 3: wirtual.ParticipantInfo.state:type_name -> wirtual.ParticipantInfo.State
	26, // 4: wirtual.ParticipantInfo.tracks:type_name -> wirtual.TrackInfo
	22, // 5: wirtual.ParticipantInfo.permission:type_name -> wirtual.ParticipantPermission
	13, // 6: wirtual.ParticipantInfo.kind:type_name -> wirtual.ParticipantInfo.Kind
	54, // 7: wirtual.ParticipantInfo.attributes:type_name -> wirtual.ParticipantInfo.AttributesEntry
	8,  // 8: wirtual.ParticipantInfo.disconnect_reason:type_name -> wirtual.DisconnectReason
	27, // 9: wirtual.SimulcastCodecInfo.layers:type_name -> wirtual.VideoLayer
	3,  // 10: wirtual.TrackInfo.type:type_name -> wirtual.TrackType
	4,  // 11: wirtual.TrackInfo.source:type_name -> wirtual.TrackSource
	27, // 12: wirtual.TrackInfo.layers:type_name -> wirtual.VideoLayer
	25, // 13: wirtual.TrackInfo.codecs:type_name -> wirtual.SimulcastCodecInfo
	14, // 14: wirtual.TrackInfo.encryption:type_name -> wirtual.Encryption.Type
	52, // 15: wirtual.TrackInfo.version:type_name -> wirtual.TimedVersion
	11, // 16: wirtual.TrackInfo.audio_features:type_name -> wirtual.AudioTrackFeature
	5,  // 17: wirtual.VideoLayer.quality:type_name -> wirtual.VideoQuality
	15, // 18: wirtual.DataPacket.kind:type_name -> wirtual.DataPacket.Kind
	31, // 19: wirtual.DataPacket.user:type_name -> wirtual.UserPacket
	29, // 20: wirtual.DataPacket.speaker:type_name -> wirtual.ActiveSpeakerUpdate
	32, // 21: wirtual.DataPacket.sip_dtmf:type_name -> wirtual.SipDTMF
	33, // 22: wirtual.DataPacket.transcription:type_name -> wirtual.Transcription
	61, // 23: wirtual.DataPacket.metrics:type_name -> wirtual.MetricsBatch
	35, // 24: wirtual.DataPacket.chat_message:type_name -> wirtual.ChatMessage
	36, // 25: wirtual.DataPacket.rpc_request:type_name -> wirtual.RpcRequest
	37, // 26: wirtual.DataPacket.rpc_ack:type_name -> wirtual.RpcAck
	38, // 27: wirtual.DataPacket.rpc_response:type_name -> wirtual.RpcResponse
	58, // 28: wirtual.DataPacket.stream_header:type_name -> wirtual.DataStream.Header
	59, // 29: wirtual.DataPacket.stream_chunk:type_name -> wirtual.DataStream.Chunk
	30, // 30: wirtual.ActiveSpeakerUpdate.speakers:type_name -> wirtual.SpeakerInfo
	34, // 31: wirtual.Transcription.segments:type_name -> wirtual.TranscriptionSegment
	39, // 32: wirtual.RpcResponse.error:type_name -> wirtual.RpcError
	16, // 33: wirtual.ServerInfo.edition:type_name -> wirtual.ServerInfo.Edition
	17, // 34: wirtual.ClientInfo.sdk:type_name -> wirtual.ClientInfo.SDK
	44, // 35: wirtual.ClientConfiguration.video:type_name -> wirtual.VideoConfiguration
	44, // 36: wirtual.ClientConfiguration.screen:type_name -> wirtual.VideoConfiguration
	7,  // 37: wirtual.ClientConfiguration.resume_connection:type_name -> wirtual.ClientConfigSetting
	45, // 38: wirtual.ClientConfiguration.disabled_codecs:type_name -> wirtual.DisabledCodecs
	7,  // 39: wirtual.ClientConfiguration.force_relay:type_name -> wirtual.ClientConfigSetting
	7,  // 40: wirtual.VideoConfiguration.hardware_encoder:type_name -> wirtual.ClientConfigSetting
	20, // 41: wirtual.DisabledCodecs.codecs:type_name -> wirtual.Codec
	20, // 42: wirtual.DisabledCodecs.publish:type_name -> wirtual.Codec
	62, // 43: wirtual.RTPDrift.start_time:type_name -> google.protobuf.Timestamp
	62, // 44: wirtual.RTPDrift.end_time:type_name -> google.protobuf.Timestamp
	62, // 45: wirtual.RTPStats.start_time:type_name -> google.protobuf.Timestamp
	62, // 46: wirtual.RTPStats.end_time:type_name -> google.protobuf.Timestamp
	55, // 47: wirtual.RTPStats.gap_histogram:type_name -> wirtual.RTPStats.GapHistogramEntry
	62, // 48: wirtual.RTPStats.last_pli:type_name -> google.protobuf.Timestamp
	62, // 49: wirtual.RTPStats.last_fir:type_name -> google.protobuf.Timestamp
	62, // 50: wirtual.RTPStats.last_key_frame:type_name -> google.protobuf.Timestamp
	62, // 51: wirtual.RTPStats.last_layer_lock_pli:type_name -> google.protobuf.Timestamp
	46, // 52: wirtual.RTPStats.packet_drift:type_name -> wirtual.RTPDrift
	46, // 53: wirtual.RTPStats.ntp_report_drift:type_name -> wirtual.RTPDrift
	46, // 54: wirtual.RTPStats.rebased_report_drift:type_name -> wirtual.RTPDrift
	46, // 55: wirtual.RTPStats.received_report_drift:type_name -> wirtual.RTPDrift
	50, // 56: wirtual.RTPForwarderState.rtp_munger:type_name -> wirtual.RTPMungerState
	51, // 57: wirtual.RTPForwarderState.vp8_munger:type_name -> wirtual.VP8MungerState
	48, // 58: wirtual.RTPForwarderState.sender_report_state:type_name -> wirtual.RTCPSenderReportState
	18, // 59: wirtual.DataStream.TextHeader.operation_type:type_name -> wirtual.DataStream.OperationType
	14, // 60: wirtual.DataStream.Header.encryption_type:type_name -> wirtual.Encryption.Type
	60, // 61: wirtual.DataStream.Header.extensions:type_name -> wirtual.DataStream.Header.ExtensionsEntry
	56, // 62: wirtual.DataStream.Header.text_header:type_name -> wirtual.DataStream.TextHeader
	57, // 63: wirtual.DataStream.Header.file_header:type_name -> wirtual.DataStream.FileHeader
