...
type SIPTrunkInfo struct {
	...
	Kind       SIPTrunkInfo_TrunkKind `protobuf:"varint,14,opt,name=kind,proto3,enum=wirtual.SIPTrunkInfo_TrunkKind" json:"kind,omitempty"`
	// CIDR or IPs that traffic is accepted from
	// An empty list means all inbound traffic is accepted.
	...
	Transport SIPTransport `protobuf:"varint,13,opt,name=transport,proto3,enum=wirtual.SIPTransport" json:"transport,omitempty"`
	// Deprecated: Marked as deprecated in wirtual_sip.proto.
...
type SIPInboundTrunkInfo struct {
	...
	IncludeHeaders SIPHeaderOptions `protobuf:"varint,15,opt,name=include_headers,json=includeHeaders,proto3,enum=wirtual.SIPHeaderOptions" json:"include_headers,omitempty"`
	...
	MediaEncryption SIPMediaEncryption   `protobuf:"varint,16,opt,name=media_encryption,json=mediaEncryption,proto3,enum=wirtual.SIPMediaEncryption" json:"media_encryption,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type SIPOutboundTrunkInfo struct {
	...
	Transport SIPTransport `protobuf:"varint,5,opt,name=transport,proto3,enum=wirtual.SIPTransport" json:"transport,omitempty"`
	...
	// lowercase header names should be used, for example: sip.h.x-custom-header.
	IncludeHeaders  SIPHeaderOptions   `protobuf:"varint,12,opt,name=include_headers,json=includeHeaders,proto3,enum=wirtual.SIPHeaderOptions" json:"include_headers,omitempty"`
	MediaEncryption SIPMediaEncryption `protobuf:"varint,13,opt,name=media_encryption,json=mediaEncryption,proto3,enum=wirtual.SIPMediaEncryption" json:"media_encryption,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type SIPDispatchRuleInfo struct {
	...
	MediaEncryption SIPMediaEncryption `protobuf:"varint,12,opt,name=media_encryption,json=mediaEncryption,proto3,enum=wirtual.SIPMediaEncryption" json:"media_encryption,omitempty"` // NEXT ID: 13
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type CreateSIPParticipantRequest struct {
	...
	// When mapping 200 OK headers to follow-up request headers with attributes_to_headers map,
	// lowercase header names should be used, for example: sip.h.x-custom-header.
	IncludeHeaders SIPHeaderOptions `protobuf:"varint,17,opt,name=include_headers,json=includeHeaders,proto3,enum=wirtual.SIPHeaderOptions" json:"include_headers,omitempty"`
	...
	MediaEncryption SIPMediaEncryption `protobuf:"varint,18,opt,name=media_encryption,json=mediaEncryption,proto3,enum=wirtual.SIPMediaEncryption" json:"media_encryption,omitempty"` // NEXT ID: 19
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type SIPCallInfo struct {
	...
	EnabledFeatures     []SIPFeature           `protobuf:"varint,14,rep,packed,name=enabled_features,json=enabledFeatures,proto3,enum=wirtual.SIPFeature" json:"enabled_features,omitempty"`
	CallStatus          SIPCallStatus          `protobuf:"varint,8,opt,name=call_status,json=callStatus,proto3,enum=wirtual.SIPCallStatus" json:"call_status,omitempty"`
	...
	DisconnectReason    DisconnectReason       `protobuf:"varint,12,opt,name=disconnect_reason,json=disconnectReason,proto3,enum=wirtual.DisconnectReason" json:"disconnect_reason,omitempty"`
...
var file_livekit_sip_proto_goTypes = []any{
	...
	(SIPCallStatus)(0),                    // 3: wirtual.SIPCallStatus
	(SIPFeature)(0),                       // 4: wirtual.SIPFeature
	(SIPTrunkInfo_TrunkKind)(0),           // 5: wirtual.SIPTrunkInfo.TrunkKind
	(*CreateSIPTrunkRequest)(nil),         // 6: wirtual.CreateSIPTrunkRequest
	(*SIPTrunkInfo)(nil),                  // 7: wirtual.SIPTrunkInfo
	(*CreateSIPInboundTrunkRequest)(nil),  // 8: wirtual.CreateSIPInboundTrunkRequest
	(*SIPInboundTrunkInfo)(nil),           // 9: wirtual.SIPInboundTrunkInfo
	(*CreateSIPOutboundTrunkRequest)(nil), // 10: wirtual.CreateSIPOutboundTrunkRequest
	(*SIPOutboundTrunkInfo)(nil),          // 11: wirtual.SIPOutboundTrunkInfo
	(*GetSIPInboundTrunkRequest)(nil),     // 12: wirtual.GetSIPInboundTrunkRequest
	(*GetSIPInboundTrunkResponse)(nil),    // 13: wirtual.GetSIPInboundTrunkResponse
	(*GetSIPOutboundTrunkRequest)(nil),    // 14: wirtual.GetSIPOutboundTrunkRequest
	(*GetSIPOutboundTrunkResponse)(nil),   // 15: wirtual.GetSIPOutboundTrunkResponse
	(*ListSIPTrunkRequest)(nil),           // 16: wirtual.ListSIPTrunkRequest
	(*ListSIPTrunkResponse)(nil),          // 17: wirtual.ListSIPTrunkResponse
	(*ListSIPInboundTrunkRequest)(nil),    // 18: wirtual.ListSIPInboundTrunkRequest
	(*ListSIPInboundTrunkResponse)(nil),   // 19: wirtual.ListSIPInboundTrunkResponse
	(*ListSIPOutboundTrunkRequest)(nil),   // 20: wirtual.ListSIPOutboundTrunkRequest
	(*ListSIPOutboundTrunkResponse)(nil),  // 21: wirtual.ListSIPOutboundTrunkResponse
	(*DeleteSIPTrunkRequest)(nil),         // 22: wirtual.DeleteSIPTrunkRequest
	(*SIPDispatchRuleDirect)(nil),         // 23: wirtual.SIPDispatchRuleDirect
	(*SIPDispatchRuleIndividual)(nil),     // 24: wirtual.SIPDispatchRuleIndividual
	(*SIPDispatchRuleCallee)(nil),         // 25: wirtual.SIPDispatchRuleCallee
	(*SIPDispatchRule)(nil),               // 26: wirtual.SIPDispatchRule
	(*CreateSIPDispatchRuleRequest)(nil),  // 27: wirtual.CreateSIPDispatchRuleRequest
	(*SIPDispatchRuleInfo)(nil),           // 28: wirtual.SIPDispatchRuleInfo
	(*ListSIPDispatchRuleRequest)(nil),    // 29: wirtual.ListSIPDispatchRuleRequest
	(*ListSIPDispatchRuleResponse)(nil),   // 30: wirtual.ListSIPDispatchRuleResponse
	(*DeleteSIPDispatchRuleRequest)(nil),  // 31: wirtual.DeleteSIPDispatchRuleRequest
	(*CreateSIPParticipantRequest)(nil),   // 32: wirtual.CreateSIPParticipantRequest
	(*SIPParticipantInfo)(nil),            // 33: wirtual.SIPParticipantInfo
	(*TransferSIPParticipantRequest)(nil), // 34: wirtual.TransferSIPParticipantRequest
	(*SIPCallInfo)(nil),                   // 35: wirtual.SIPCallInfo
	(*SIPUri)(nil),                        // 36: wirtual.SIPUri
	nil,                                   // 37: wirtual.SIPInboundTrunkInfo.HeadersEntry
	nil,                                   // 38: wirtual.SIPInboundTrunkInfo.HeadersToAttributesEntry
	nil,                                   // 39: wirtual.SIPInboundTrunkInfo.AttributesToHeadersEntry
	nil,                                   // 40: wirtual.SIPOutboundTrunkInfo.HeadersEntry
	nil,                                   // 41: wirtual.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	nil,                                   // 42: wirtual.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	nil,                                   // 43: wirtual.CreateSIPDispatchRuleRequest.AttributesEntry
	nil,                                   // 44: wirtual.SIPDispatchRuleInfo.AttributesEntry
	nil,                                   // 45: wirtual.CreateSIPParticipantRequest.ParticipantAttributesEntry
	nil,                                   // 46: wirtual.CreateSIPParticipantRequest.HeadersEntry
	nil,                                   // 47: wirtual.TransferSIPParticipantRequest.HeadersEntry
	(*durationpb.Duration)(nil),           // 48: google.protobuf.Duration
	(*RoomConfiguration)(nil),             // 49: wirtual.RoomConfiguration
...
var file_livekit_sip_proto_depIdxs = []int32{
	...
	37, // 3: wirtual.SIPInboundTrunkInfo.headers:type_name -> wirtual.SIPInboundTrunkInfo.HeadersEntry
	38, // 4: wirtual.SIPInboundTrunkInfo.headers_to_attributes:type_name -> wirtual.SIPInboundTrunkInfo.HeadersToAttributesEntry
	39, // 5: wirtual.SIPInboundTrunkInfo.attributes_to_headers:type_name -> wirtual.SIPInboundTrunkInfo.AttributesToHeadersEntry
	1,  // 6: wirtual.SIPInboundTrunkInfo.include_headers:type_name -> wirtual.SIPHeaderOptions
	48, // 7: wirtual.SIPInboundTrunkInfo.ringing_timeout:type_name -> google.protobuf.Duration
	48, // 8: wirtual.SIPInboundTrunkInfo.max_call_duration:type_name -> google.protobuf.Duration
	2,  // 9: wirtual.SIPInboundTrunkInfo.media_encryption:type_name -> wirtual.SIPMediaEncryption
	11, // 10: wirtual.CreateSIPOutboundTrunkRequest.trunk:type_name -> wirtual.SIPOutboundTrunkInfo
	0,  // 11: wirtual.SIPOutboundTrunkInfo.transport:type_name -> wirtual.SIPTransport
	40, // 12: wirtual.SIPOutboundTrunkInfo.headers:type_name -> wirtual.SIPOutboundTrunkInfo.HeadersEntry
	41, // 13: wirtual.SIPOutboundTrunkInfo.headers_to_attributes:type_name -> wirtual.SIPOutboundTrunkInfo.HeadersToAttributesEntry
	42, // 14: wirtual.SIPOutboundTrunkInfo.attributes_to_headers:type_name -> wirtual.SIPOutboundTrunkInfo.AttributesToHeadersEntry
	1,  // 15: wirtual.SIPOutboundTrunkInfo.include_headers:type_name -> wirtual.SIPHeaderOptions
	2,  // 16: wirtual.SIPOutboundTrunkInfo.media_encryption:type_name -> wirtual.SIPMediaEncryption
	9,  // 17: wirtual.GetSIPInboundTrunkResponse.trunk:type_name -> wirtual.SIPInboundTrunkInfo
	11, // 18: wirtual.GetSIPOutboundTrunkResponse.trunk:type_name -> wirtual.SIPOutboundTrunkInfo
	7,  // 19: wirtual.ListSIPTrunkResponse.items:type_name -> wirtual.SIPTrunkInfo
	9,  // 20: wirtual.ListSIPInboundTrunkResponse.items:type_name -> wirtual.SIPInboundTrunkInfo
	11, // 21: wirtual.ListSIPOutboundTrunkResponse.items:type_name -> wirtual.SIPOutboundTrunkInfo
	23, // 22: wirtual.SIPDispatchRule.dispatch_rule_direct:type_name -> wirtual.SIPDispatchRuleDirect
	24, // 23: wirtual.SIPDispatchRule.dispatch_rule_individual:type_name -> wirtual.SIPDispatchRuleIndividual
	25, // 24: wirtual.SIPDispatchRule.dispatch_rule_callee:type_name -> wirtual.SIPDispatchRuleCallee
	26, // 25: wirtual.CreateSIPDispatchRuleRequest.rule:type_name -> wirtual.SIPDispatchRule
	43, // 26: wirtual.CreateSIPDispatchRuleRequest.attributes:type_name -> wirtual.CreateSIPDispatchRuleRequest.AttributesEntry
	49, // 27: wirtual.CreateSIPDispatchRuleRequest.room_config:type_name -> wirtual.RoomConfiguration
	26, // 28: wirtual.SIPDispatchRuleInfo.rule:type_name -> wirtual.SIPDispatchRule
	44, // 29: wirtual.SIPDispatchRuleInfo.attributes:type_name -> wirtual.SIPDispatchRuleInfo.AttributesEntry
	49, // 30: wirtual.SIPDispatchRuleInfo.room_config:type_name -> wirtual.RoomConfiguration
	2,  // 31: wirtual.SIPDispatchRuleInfo.media_encryption:type_name -> wirtual.SIPMediaEncryption
	28, // 32: wirtual.ListSIPDispatchRuleResponse.items:type_name -> wirtual.SIPDispatchRuleInfo
	45, // 33: wirtual.CreateSIPParticipantRequest.participant_attributes:type_name -> wirtual.CreateSIPParticipantRequest.ParticipantAttributesEntry
	46, // 34: wirtual.CreateSIPParticipantRequest.headers:type_name -> wirtual.CreateSIPParticipantRequest.HeadersEntry
	1,  // 35: wirtual.CreateSIPParticipantRequest.include_headers:type_name -> wirtual.SIPHeaderOptions
	48, // 36: wirtual.CreateSIPParticipantRequest.ringing_timeout:type_name -> google.protobuf.Duration
	48, // 37: wirtual.CreateSIPParticipantRequest.max_call_duration:type_name -> google.protobuf.Duration
	2,  // 38: wirtual.CreateSIPParticipantRequest.media_encryption:type_name -> wirtual.SIPMediaEncryption
	47, // 39: wirtual.TransferSIPParticipantRequest.headers:type_name -> wirtual.TransferSIPParticipantRequest.HeadersEntry
	36, // 40: wirtual.SIPCallInfo.from_uri:type_name -> wirtual.SIPUri
	36, // 41: wirtual.SIPCallInfo.to_uri:type_name -> wirtual.SIPUri
	4,  // 42: wirtual.SIPCallInfo.enabled_features:type_name -> wirtual.SIPFeature
	3,  // 43: wirtual.SIPCallInfo.call_status:type_name -> wirtual.SIPCallStatus
	50, // 44: wirtual.SIPCallInfo.disconnect_reason:type_name -> wirtual.DisconnectReason
	0,  // 45: wirtual.SIPUri.transport:type_name -> wirtual.SIPTransport
	16, // 46: wirtual.SIP.ListSIPTrunk:input_type -> wirtual.ListSIPTrunkRequest
	8,  // 47: wirtual.SIP.CreateSIPInboundTrunk:input_type -> wirtual.CreateSIPInboundTrunkRequest
	10, // 48: wirtual.SIP.CreateSIPOutboundTrunk:input_type -> wirtual.CreateSIPOutboundTrunkRequest
	12, // 49: wirtual.SIP.GetSIPInboundTrunk:input_type -> wirtual.GetSIPInboundTrunkRequest
	14, // 50: wirtual.SIP.GetSIPOutboundTrunk:input_type -> wirtual.GetSIPOutboundTrunkRequest
	18, // 51: wirtual.SIP.ListSIPInboundTrunk:input_type -> wirtual.ListSIPInboundTrunkRequest
	20, // 52: wirtual.SIP.ListSIPOutboundTrunk:input_type -> wirtual.ListSIPOutboundTrunkRequest
	22, // 53: wirtual.SIP.DeleteSIPTrunk:input_type -> wirtual.DeleteSIPTrunkRequest
	27, // 54: wirtual.SIP.CreateSIPDispatchRule:input_type -> wirtual.CreateSIPDispatchRuleRequest
	29, // 55: wirtual.SIP.ListSIPDispatchRule:input_type -> wirtual.ListSIPDispatchRuleRequest
	31, // 56: wirtual.SIP.DeleteSIPDispatchRule:input_type -> wirtual.DeleteSIPDispatchRuleRequest
	32, // 57: wirtual.SIP.CreateSIPParticipant:input_type -> wirtual.CreateSIPParticipantRequest
	34, // 58: wirtual.SIP.TransferSIPParticipant:input_type -> wirtual.TransferSIPParticipantRequest
	17, // 59: wirtual.SIP.ListSIPTrunk:output_type -> wirtual.ListSIPTrunkResponse
	9,  // 60: wirtual.SIP.CreateSIPInboundTrunk:output_type -> wirtual.SIPInboundTrunkInfo
	11, // 61: wirtual.SIP.CreateSIPOutboundTrunk:output_type -> wirtual.SIPOutboundTrunkInfo
	13, // 62: wirtual.SIP.GetSIPInboundTrunk:output_type -> wirtual.GetSIPInboundTrunkResponse
	15, // 63: wirtual.SIP.GetSIPOutboundTrunk:output_type -> wirtual.GetSIPOutboundTrunkResponse
	19, // 64: wirtual.SIP.ListSIPInboundTrunk:output_type -> wirtual.ListSIPInboundTrunkResponse
	21, // 65: wirtual.SIP.ListSIPOutboundTrunk:output_type -> wirtual.ListSIPOutboundTrunkResponse
	7,  // 66: wirtual.SIP.DeleteSIPTrunk:output_type -> wirtual.SIPTrunkInfo
	28, // 67: wirtual.SIP.CreateSIPDispatchRule:output_type -> wirtual.SIPDispatchRuleInfo
	30, // 68: wirtual.SIP.ListSIPDispatchRule:output_type -> wirtual.ListSIPDispatchRuleResponse
	28, // 69: wirtual.SIP.DeleteSIPDispatchRule:output_type -> wirtual.SIPDispatchRuleInfo
	33, // 70: wirtual.SIP.CreateSIPParticipant:output_type -> wirtual.SIPParticipantInfo
	51, // 71: wirtual.SIP.TransferSIPParticipant:output_type -> google.protobuf.Empty
